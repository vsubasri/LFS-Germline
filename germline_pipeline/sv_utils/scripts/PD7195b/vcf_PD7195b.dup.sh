...
#PBS -W depend=afterok:49992748:49992749

module load python/3.4.0
module load samtools/1.2

python /hpf/largeprojects/adam/local/sw/pype/2.3.1/vcf2tab/vcf2tab.py --vcf /hpf/largeprojects/adam/projects/lfs/code/germline_pipeline/sv_utils/data/PD7195b/normal_PD7195b.dup.tab.vcf \
                                            ...
                                            --name normal_PD7195b.dup.tab \
                                            --lowqual True

python /hpf/largeprojects/adam/local/sw/pype/2.3.1/vcf2tab/vcf2tab.py --vcf /hpf/largeprojects/adam/projects/lfs/code/germline_pipeline/sv_utils/data/PD7195b/tumor_PD7195b.dup.tab.vcf \
                                            --output /hpf/largeprojects/adam/projects/lfs/code/germline_pipeline/sv_utils/data/PD7195b/ \
                                            --bam /hpf/largeprojects/adam/projects/lfs/lfs_germline/aligned_bams/NA12878/NA12878_20k.b37.bam \
                                            --name tumor_PD7195b.dup.tab 