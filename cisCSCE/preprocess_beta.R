...
BRaw_cleaned <- dataRaw[45:length(dataRaw)]
BRaw_cleaned <- BRaw_cleaned[, colSums(is.na(BRaw_cleaned)) == 0]
B_cleaned <- dataNoob[45:length(dataNoob)]
...
generate_pcsummary(pc_clin,"Raw_beta_PCA_summary.csv")
generate_pcplots(pc_clin,"Raw_beta")
...
generate_pcsummary(pc_clin,"Noob_beta_PCA_summary.csv")
generate_pcplots(pc_clin,"Noob_beta")
...
generate_pcsummary(pc_clin,"Noob_beta_NoSex_PCA_summary.csv")
generate_pcplots(pc_clin,"Noob_beta_NoSex")

cat("[ Plotting technical replicates ]","\n")

duplicated_data <- get_technicalreplicates(dataNoob)
plot_concordance(duplicated_data,"Noob_beta")
...
generate_pcsummary(pc_clin,'Noob_beta_TechnicalReplicates_PCA_summary.csv')
generate_pcplots(pc_clin,'Noob_beta_TechnicalReplicates')
