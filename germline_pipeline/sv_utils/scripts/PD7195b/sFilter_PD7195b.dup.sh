...
#PBS -W depend=afterok:49992750

module load python/3.4.0
module load samtools/1.2

python /hpf/largeprojects/adam/local/sw/pype/2.3.1/vcf2tab/somaticFilter.py --normal /hpf/largeprojects/adam/projects/lfs/code/germline_pipeline/sv_utils/data/PD7195b/normal_PD7195b.dup.tab \
                                                  --tumor  /hpf/largeprojects/adam/projects/lfs/code/germline_pipeline/sv_utils/data/PD7195b/tumor_PD7195b.dup.tab \
